...
import com.example.logicloom.databinding.RowCommentBinding;
...
public class AdapterComment extends RecyclerView.Adapter<AdapterComment.HolderComment> {
    ...
    public void onBindViewHolder(@NonNull HolderComment holder, int position) {
        ...
        //we don't have user's name, profile picture, so we will load it using uid we started in each comment
        ...
        builder.setTitle("Delete Comment")
                ...
                .setPositiveButton("DELETE", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        //delete from dialog clciked, begin delete
    ...
    public int getItemCount() {
        return commentArrayList.size(); //return comments size
    }
