package com.example.logicloom;

import static com.example.logicloom.Constants.MAX_BYTES_PDF;
...
import com.example.logicloom.adapters.AdapterPdfAdmin;
...
//application class run before launcher activity
public class MyApplication extends Application {
                        ...
                        pdfView.fromBytes(bytes)
                                ...
                                .onLoad(new OnLoadCompleteListener() {
                                    ...
                                    public void loadComplete(int nbPages) {
                                        ...
                                        //if pagesTv params not null, then set page numbers
                                        if (pagesTv != null) {
                                            pagesTv.setText(""+nbPages); //cancatenate with "" beacause can't set in textview
                                        }
                                    }
                                })
                                .load();
    ...
    public static void downloadBook(Context context, String bookId, String bookTitle, String bookUrl) {
        Log.d(TAG_DOWNLOAD, "downloadBook: downloading..");
        ...
        storageReference.getBytes(MAX_BYTES_PDF)
                .addOnSuccessListener(new OnSuccessListener<byte[]>() {
                    ...
                    public void onSuccess(byte[] bytes) {
                        ...
                        Log.d(TAG_DOWNLOAD, "onSuccess: Save Book..");
