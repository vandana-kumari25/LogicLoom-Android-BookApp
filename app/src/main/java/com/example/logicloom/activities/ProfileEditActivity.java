...
import com.example.logicloom.databinding.ActivityProfileEditBinding;
...
public class ProfileEditActivity extends AppCompatActivity {
    ...
    private void uploadImage() {
        Log.d(TAG, "uploadImage: Updating profile image..");
        ...
        reference.putFile(imageUri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        Log.d(TAG, "onSuccess: image Updated");
                        Log.d(TAG, "onSuccess: Getting uploaded image");
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(ProfileEditActivity.this, "Failed to upload due to "+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
        ...
        databaseReference.child(firebaseAuth.getUid())
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(ProfileEditActivity.this, "Failed update due to "+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult o) {
                    ...
                    if (o.getResultCode() == Activity.RESULT_OK) {
                        ...
                        Intent data = o.getData(); //no need here as in camera case we already have image in imageUri variable
