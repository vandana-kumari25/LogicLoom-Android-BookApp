...
import com.example.logicloom.adapters.AdapterComment;
import com.example.logicloom.adapters.AdapterPdfFavorite;
import com.example.logicloom.databinding.ActivityPdfDetailBinding;
import com.example.logicloom.databinding.DialogCommentAddBinding;
import com.example.logicloom.models.ModelComment;
...
public class PdfDetailActivity extends AppCompatActivity {
    ...
    private ArrayList<ModelComment> commentArrayList;  // for holding comments
    private AdapterComment adapterComment;  //adapter
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.downloadBookBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ContextCompat.checkSelfPermission(PdfDetailActivity.this,Manifest.permission.WRITE_EXTERNAL_STORAGE)
                    ...
                    Log.d(TAG_DOWNLOAD, "onClick: Permission already granted, download book");
                    ...
                    Log.d(TAG_DOWNLOAD, "onClick: Permission not granted, request permission");
        ...
        binding.addCommentBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (firebaseAuth.getCurrentUser() == null) {
                    Toast.makeText(PdfDetailActivity.this, "Not logged in..", Toast.LENGTH_SHORT).show();
                }
                else {
                    addCommentDialog();
                }
        ...
        ref.child(bookId).child("Comments").child(timestamp)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(PdfDetailActivity.this, "Failed to comment due to "+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
